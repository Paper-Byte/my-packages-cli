...
def main_menu_options():
    ...
    print('[grey53]*[/grey53]  [bold][dark_turquoise]"lang" [magenta][italic]OR[/italic][/magenta] "l"[/bold][/dark_turquoise][grey53] to view languages', ':glasses:')
    print('[dark_turquoise]*[/dark_turquoise]  [bold][dark_turquoise]"pack" [magenta][italic]OR[/italic][/magenta] "p"[/bold][/dark_turquoise][grey53] to view packages', ':glasses:')
    print('[grey53]*[/grey53]  [bold][dark_turquoise]"dev" [magenta][italic]OR[/italic][/magenta] "d"[/bold][/dark_turquoise][grey53] to use dev tools', ':gear:')
