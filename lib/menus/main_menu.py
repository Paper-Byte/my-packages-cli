...
def main_menu_options():
    print('[bold][dark_turquoise]"exit" [magenta][italic]OR[/italic][/magenta] "e"[/bold][/dark_turquoise][grey53] to exit the program', ':stop_sign:')
    print('[bold][dark_turquoise]"lang" [magenta][italic]OR[/italic][/magenta] "l"[/bold][/dark_turquoise][grey53] to view languages', ':robot:')
    print('[bold][dark_turquoise]"pack" [magenta][italic]OR[/italic][/magenta] "p"[/bold][/dark_turquoise][grey53] to view packages', ':robot:')
    print('[bold][dark_turquoise]"dev" [magenta][italic]OR[/italic][/magenta] "d"[/bold][/dark_turquoise][grey53] to use dev tools', ':robot:')
